    ...
    this.getArtist = function(artist){
      ...
      $http({
        ...
        for(var i = 0; i < info.length; i++){
          var obj = {};
          obj.AlbumArt = info[i].artworkUrl100;
          obj.Song = info[i].trackName;
          obj.Artist = info[i].artistName;
          obj.Collection = info[i].collectionName;
          obj.CollectionPrice = info[i].collectionPrice;
          obj.Play = info[i].previewUrl;
          obj.Type = info[i].wrapperType;
          sorted.push(obj);
        }
